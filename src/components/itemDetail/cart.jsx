    ...
    <div>
      <div className="container-fluid fondo">
        <div className="row d-flex justify-content-center">
          <div className="card text-center" style={{ width: 900, height:1110 }}>
                ...
                <div className="row align-items-center">
                    <div className="col">
                        <form className="row g-3" onSubmit={handleSubmit}>
                            <img className='logo rounded mx-auto d-block' src={CarWidget.logo007Negro}/>
                            <h2 className="text-center titulos__cart fs-1">Completa Tus Datos</h2>
                            <div className="col-md-6">
                                <label htmlFor="validationDefault01" className="form-label">Nombre</label>
                                <input type="text" className="form-control text-center" id="nombre" placeholder="Ingrese su Nombre" value={name} onChange={(e)=> setName(e.target.value)} required />
                            </div>
                            <div className="col-md-6">
                                <label htmlFor="validationDefault02" className="form-label">Apellido</label>
                                <input type="text" className="form-control text-center" id="apellido" placeholder="Ingrese su Apellido" value={apell} onChange={(e)=> setApell(e.target.value)} required />
                            </div>
                            <div className="col-md-6">
                                <label htmlFor="validationDefaultUsername" className="form-label">Email</label>
                                <div className="input-group">
                                    <span className="input-group-text" id="inputGroupPrepend2">@</span>
                                    <input type="email" className="form-control text-center" id="email" aria-describedby="inputGroupPrepend2" placeholder="Ingrese su Email" value={email} onChange={(e)=> SetEmail(e.target.value)} required />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <label htmlFor="validationDefault03" className="form-label">Ciudad</label>
                                <input type="text" className="form-control text-center" id="ciudad" placeholder="Ingrese la Ciudad" value={city} onChange={(e)=> setCity(e.target.value)} required />
                            </div>
                            <div className="col-md-6">
                                <label htmlFor="validationDefault03" className="form-label ">Usuario</label>
                                <input type="text" className="form-control text-center" id="usuario" placeholder="Ingrese un Usuario" value={usuario} onChange={(e)=> setUsuario(e.target.value)} required />
                            </div>
                            <div className="col-md-6">
                                <label htmlFor="validationDefault03" className="form-label ">Contraseña</label>
                                <input type="password" className="form-control text-center" id="contraseña" placeholder="Ingrese una Contraseña" value={password} onChange={(e)=> setPassword(e.target.value)} required />
                            </div> 
