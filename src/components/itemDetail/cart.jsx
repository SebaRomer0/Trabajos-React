                        ...
                        <form className="row g-3" onSubmit={handleSubmit}>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="input-group">
                                    ...
                                    <input type="text" className="form-control text-center" id="email" aria-describedby="inputGroupPrepend2" placeholder="Ingrese su Email" value={email} onChange={(e)=> SetEmail(e.target.value)} required />
                                </div>
                            </div>
                            <div className="col-md-6">
